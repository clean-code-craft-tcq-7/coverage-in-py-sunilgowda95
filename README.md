...
Decomposing GOD file, Identifying and creating pure functions, Reducing cyclomatic complexity, Add test cases to cover all the path (and to use stubs where it is needed).
